...
Symbol Scribe 是一款 macOS 应用，帮助你在消息、邮件和社交应用中快速插入表情符号、颜文字以及各类符号。它让你可以方便地浏览和复制所需符号，并在日常交流中直接使用。

你的反馈和支持非常重要！如果你遇到任何问题、有疑问，或想提出新功能建议，请随时联系我们。你的意见将帮助我们改进这个工具，确保为你提供最佳使用体验。  

你可以通过应用内或发送邮件至 **kennyiseeyou@gmail.com** 联系我们。我致力于为你提供支持，确保你拥有流畅、愉快的使用体验。感谢你选择 Symbol Scribe！  
...
- [**GitHub 问题反馈**](https://github.com/jaywcjlove/symbol-scribe/issues/new/choose)  
